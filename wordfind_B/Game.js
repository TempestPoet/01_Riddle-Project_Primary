...
function validateSelection()
{
    ...
    if (found.length === wordArray.length)
    {
        showScene("Congrats");
    }
}
...
function displayWords()
{
    ...
    {
        fill( foundWord(wordArray[i]) ? "Gray" : "White" );
        text(wordArray[i], 30, matrixY + 20 + i * 50);
    }
    pop();
}
